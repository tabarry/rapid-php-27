...
define('MYSQL_ERROR_DETAILS', 'Error: ');
...
define('SINGLE_UPDATE_MESSAGE', 'Record updated.');
...
define('RECORDS_SORTED', 'Records sorted.');
define('QUICK_PICK_ERROR', 'The target element can only be a textbox or textarea.');
define('CHANGE_PASSWORD_MESSAGE', 'Leave password fields blank if you do not want to change the password.');
